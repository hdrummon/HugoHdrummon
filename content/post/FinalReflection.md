...
In some weeks however I found that there was no problem statement that came to mind, such as in Week 1 and Week 4 I didn’t interact with any stakeholders because I wasn’t aware that I could use our tutors as stakeholders, nor did I have any problem in Week4 at the time and during Week1 I was away.
Every other week I managed to interact with different stakeholders, and rather than come up with one major problem statement I had several minor statements. 
A list of stakeholders I interacted with over the studio include:
<ul>
<li>
...
I follow a very similar process the three major E's, Enumerate, Exploit and Escalate. By using these "major E's" I was better able to utilise a design thinking methodology approach when attempting a box or vulnerable machine.
For example, if I were to attempt a box, I would go through mostly the Define through to Testing stages.
<ol>
<li>
**Define** (The problem): Navigate through the machine to get Root.
</li>
<li>
**Ideate** (Create many ideas through brainstorming): Enumerate a systems files to find a possible lead or exploit.
</li>
<li>
**Prototype** (Hands-on approach): Finding and probing a potential exploit.
</li>
<li>
**Test** (Testing solutions): Using a version exploit or escalate user.
</li>
</ol>
This approach would repeat until the desired goal is complete.
...
<li>
**Week 2** 
- *NetworkMapper (NMAP)/Zenmap and Linux CLI*: Used a lot of Linux CLI in OverTheWire / PicoCTP challenges and NMAP for presentation (Demonstration can be found **<a href="https://www.hdrummon.me/post/reflection2/">**here. </a>). 
<figure>
...
<li>
**Week 3** 
- *Linux CLI, GIT, SQL Injection and Web Application based tools (Inspect element, Console, Network) *: Used a mixture of Linux CLI and Web Application attacks for OverTheWire-Natas challenges and other wargames. SQL Injections was primarily used for our presentation but also used on OWASP Juice Shop (Demonstration can be found **<a href="https://www.hdrummon.me/post/reflection3/">**here. </a>).
<figure>
<img src="/img/sql.png" >
<figcaption>
...
During both presentations, Facebook Messenger and Microsoft Teams were the main mediums of communication between each member. 
Although during the Week 2 presentation we attempted to use Trello to help manage our progress, it didn’t necessarily work out (This is further discussed in **<a href="https://www.hdrummon.me/post/reflection2/">**Reflection 2</a>)
<figure>
<img src="/img/Untitled.png" >
<figcaption>
*Incomplete stages in Trello board*
</figcaption>
</figure>
But for later deliverables, while they were often individual, I would use Discord to voice chat with other students to collaborate on certain issues that we had for that deliverable or for challenges on Hack-the-Box.
<figure>
